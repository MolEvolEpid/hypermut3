...
def test_find_match_weight():
  ...
  assert find_match_weight('GGG', 'AGT', 2, 3, 'A', ['RD'], ['.'], 'A', iupac_dict, 'strict', False) == (1,0,0,0)
  assert find_match_weight('GGG', 'AGT', 2, 3, 'A', ['RD'], ['.'], 'B', iupac_dict, 'strict', False) == (1,0,0,0)
...
def test_summarize_matches():
  ...
  assert summarize_matches('GAGAT', 'A-G-T', 0, 1,
                           re.compile('G'), 'D',
                           'A', ['.'], ['RD'],
                           iupac_dict, 'strict', False, 1, 'test', None) == (1,1,0,0)
  assert summarize_matches('GAGAT', 'A-G-T', 0, 0,
                           re.compile('G'), 'D',
                           'A', ['.'], ['RD'],
                           iupac_dict, 'strict', False, 1, 'test', None) == (0,0,0,0)
